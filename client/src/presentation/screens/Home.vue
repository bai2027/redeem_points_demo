...
<template>
  <div class="home-page">
    <Placeholder
      ...
      class="landing"
      title="☕ Brew Points"
      caption="Redeem rewards as easy as ordering coffee"
      :class="{
        ...
        >
          ...
          >
            <ListCard
              ...
              :title="index === 3 ? 'Users choice' : 'Cafe of the year'"
            ...
            >
              <template #visible>
                ...
                >
                  <template #right>
                    from {{ shortNumber(hotel.price * days) }} pts
                  </template>
                </ListItem>
              </template>
              <template #collapsed>
                  ...
                  <Section padded>
                    <List>
                      <ListItem
                        ...
                        :subtitle="`3 tasty rewards waiting!`"
                        :to="`/hotel/${hotel.id}`"
                        right-icon="chevron-right"
                        standalone
                      />
