...
const pointsToUsdtRate = 500; // 1 USDT = 500 pts
...
function convertToUsdt() {
  ...
  alert(`Converting points to USDT at rate: ${pointsToUsdtRate}pts = 1 USDT`);
}
</script>
<template>
  <div v-if="hotel">
    ...
    <Sections>
      ...
      <!-- Add this right after the REWARDS section -->
<Section
...
>
  <List with-background standalone>
    <ListItem
      title="Convert Points to USDT"
      subtitle="500 points = 1 USDT"
    >
      <template #right>
...
/* Optional: Add a different color for conversion button */
.conversion-cell .book {
  background-color: #26A17B; /* USDT brand green */
  color: white;
}
.book {
  display: inline-flex;
